  ...
  <div class="container container--narrow page-section">
    ...
    <div class="generic-content">
      ...
      if ($skyColor == 'blue' and $grassColor == 'green') {
        echo '<p>The sky is blue and the grass is green today.</p>'; // http://fictional-university-block-theme.local/about-us/?skyColor=blue&grassColor=green
      }
      ?>
      <form method="post"> <!-- Include the method="get" so the properties appear on the address bar and people can share it -->
